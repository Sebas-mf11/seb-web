...
`
    ...
    class ExternalForce extends ShaderPass {
      ...
      initWithProps(simProps: { cellScale: THREE.Vector2; cursor_size: number }) {
        super.init()
      ...
      update(args?: { cursor_size?: number; mouse_force?: number; cellScale?: THREE.Vector2 }) {
        const props = args || {}
    ...
    class Divergence extends ShaderPass {
      ...
      update(args?: { vel?: THREE.WebGLRenderTarget | null }) {
        const { vel } = args || {}
    ...
    class Pressure extends ShaderPass {
      ...
      update(args?: { vel?: THREE.WebGLRenderTarget | null; pressure?: THREE.WebGLRenderTarget | null }) {
  ...
  return (
    <div
      ref={mountRef}
      className={`relative h-full w-full touch-none overflow-hidden pointer-events-none ${className || ''}`}
      style={style}
    />
  )
}
